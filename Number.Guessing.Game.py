''' The aim of project is to create a number guessing game in which the computer itself generate a number and user have to guess it
in limited number of turns '''
